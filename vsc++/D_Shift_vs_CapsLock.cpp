...
ll dp[300001][2];
ll f(ll i, ll caps, string &s, ll x, ll y, ll z)
{
    if (i == s.size())
        return 0;
    if (dp[i][caps] != -1)
    ...
    if (caps)
    {
        if (s[i] == 'a')
        {
            return dp[i][caps]=min(z + x + f(i + 1, caps ^ 1, s, x, y, z), y + f(i + 1, caps, s, x, y, z));
        }
        else
        {
            return dp[i][caps]=min(x + f(i + 1, caps, s, x, y, z), z + y + f(i + 1, caps^1, s, x, y, z));
        }
    }
    else
    {
